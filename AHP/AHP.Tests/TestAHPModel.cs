...
namespace AHP.Tests
{
    ...
    {
        [Test()]
        public void TestCreateAHPModel()
        {
            ...
            ahpModelData.CriteriaComparisons.SetComparison("C2", "C3", 2); // Camera Quality is slightly more important than Battery Life

            ahpModelData.AlternativeComparisons["C1"].SetComparison("A1", "A2", 4); // For Price, A1 is strongly preferred over A2
            ...
            ahpModelData.AlternativeComparisons["C2"].SetComparison("A2", "A3", 4); // For Camera Quality, A2 is strongly preferred over A3
